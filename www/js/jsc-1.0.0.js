...
i18n.en = {
  //customIRCELINE
    info: {
      ...
      BC_description: 'Black carbon (BC) or soot is the most strongly light-absorbing component of particulate matter (PM) and is formed during incomplete combustion of fossil fuels (e.g. diesel), biofuels (e.g. bio-diesel), and biomass (e.g. wood). BC is emitted directly into the atmosphere in the form of fine particles (smaller than 2.5 µm, see PM2.5). There is evidence of carcinogenic effects of BC and this pollutant is also a known as a “short-lived climate forcer”. This means that there is a clear relation between climate change and BC, but this pollutant remains in the atmosphere much shorter than e.g. carbon dioxide (CO2). After CO2, BC is the second most important factor with regards to climate change.',
      NO2_description: 'Nitrogen dioxide (NO2) is emitted during combustion at  high temperatures (e.g. diesel engines, industrial processes). NO2 is considered a good proxy for traffic related air pollution, but there are also significant industrial sources. NO2 is an important precursor for the formation of ozone (summer-SMOG) and “Secondary Inorganic Aerosols” (fine particles). There is growing evidence of detrimental health effects of this pollutant (adverse respiratory effects including airway inflammation).',
      O3_description: 'High ozone (O3) concentrations are associated with hot, sunny days. O3 is formed in a photochemical reaction when nitrogen oxides (NOx) and volatile organic compounds (VOCs) react in the atmosphere in the presence of sunlight (UV - ultra violate radiation). Ozone concentrations are typically lower close to traffic emissions since (diesel) engines also emit nitrogen monoxide (NO), which consumes formed O3. Indoors ozone concentrations are typically about half as high as outdoor concentrations during summer-SMOG episodes. High ozone concentration have well documented adverse respiratory effects.',
      PM10_description: 'The mass of all particles smaller than 10 µm. This fraction of particulate matter (PM) has many other sources besides combustion and the scientific evidence of detrimental health effects are well documented. A large part of PM10 is typically secondary, meaning that particles are formed in the presence of precursors (Nitrogen oxides – NOx – from traffic/industry, Sulphur dioxide – SO2 – from industry and ammonia – NH3 – primarily agricultural emissions).',
      PM25_description: 'The mass of all particles smaller than 2.5 µm. There is a clear link between higher mortality risk and high PM2.5 concentrations. Besides traffic and industrial emissions, secondary emissions play a significant role (see explanation PM10). PM2.5 is more harmful for human health than PM10. PM2.5 is by far the most important pollutant linked to adverse effects on human health. There is a better relationship between traffic emissions and PM2.5 than PM10.',
      source: 'Source:',
