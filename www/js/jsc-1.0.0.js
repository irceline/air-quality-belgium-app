...
//customIRCELINE
  info: {
    ...
    BC_description: 'Schwarzer Kohlenstoff (BC) oder Ruß ist der am stärksten lichtabsorbierende Bestandteil vom Feinstaub (PM) und wird während der unvollständigen Verbrennung fossiler Energieträger (z.B. Diesel), Biokraftstoffe (z.B. Biodiesel) und Biomasse (z.B. Holz) erzeugt. BC wird direkt in die Atmosphäre in Form von feinen Partikeln (kleiner als 2,5 µm, sehe Beschreibung PM2,5) emittiert. Es gibt Hinweise der krebserregenden Wirkung von BC und dieser Schadstoff ist auch bekannt als "kurzlebiger klimawirksamer Schadstoff". Dies bedeutet, dass es einen klaren Zusammenhang zwischen Klimawandel und BC gibt, aber das dieser Schadstoff viel kürzer als z.B. Kohlendioxid (CO<sub>2</sub>) in der Atmosphäre bleibt. Nach CO<sub>2</sub> ist BC der zweitwichtigste Faktor im Bezug auf den Klimawandel.',
